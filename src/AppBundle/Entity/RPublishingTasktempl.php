 ...
 *
 * @ORM\Table(name="r_publishing_tasktempl", indexes={@ORM\Index(name="publishing_tasktempl_FKIndex1", columns={"workflow_id"}), @ORM\Index(name="publishing_tasktempl_FKIndex2", columns={"publishing_task_type_id"})})
 * @ORM\Entity
 */
